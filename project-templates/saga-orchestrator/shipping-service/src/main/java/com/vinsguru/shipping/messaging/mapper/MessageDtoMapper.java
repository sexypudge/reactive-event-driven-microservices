...
public class MessageDtoMapper {
    ...
    public static ShippingResponse toScheduleResponse(ShipmentDto dto) {
    ...
    public static Function<Throwable, Mono<ShippingResponse>> toDeclinedShippingResponse(ShippingRequest.Schedule request) {
