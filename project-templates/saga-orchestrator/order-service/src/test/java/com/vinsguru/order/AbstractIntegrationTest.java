...
@SpringBootTest(properties = {
        ...
        // orderConsumer will consume event (via resFlux) from payment-request,inventory-request,shipping-request
        // Pure testing setup
        //Simulates destinations for commands
        //Allows verification of orchestrator behavior
        //No real services involved
        //All in-memory with embedded Kafka
...
public abstract class AbstractIntegrationTest {
    ...
    protected static final Sinks.Many<Request> resSink = Sinks.many().multicast().onBackpressureBuffer();
...
//    Use case: If you want new subscribers to receive past events upon subscribing.
    protected static final Flux<Request> resFlux = resSink.asFlux().cache(0);
