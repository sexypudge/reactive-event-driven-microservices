...
public class PaymentEventMapper {
    ...
    public static OrderPaymentDto toDto(PaymentEvent.Deducted event) {
    ...
    public static OrderPaymentDto toDto(PaymentEvent.Declined event) {
        return OrderPaymentDto.builder()
                              .orderId(event.orderId())
    ...
    public static OrderPaymentDto toDto(PaymentEvent.Refunded event) {
        return OrderPaymentDto.builder()
                              .orderId(event.orderId())
