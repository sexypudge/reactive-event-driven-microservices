...
@Slf4j
/**
 * this class to update, cancel and complete order
 */
public class OrderFulfillmentServiceImpl implements OrderFulfillmentService {
    ...
    private Function<Mono<PurchaseOrder>, Mono<PurchaseOrderDto>> updateStatus(OrderStatus status) {
        return mono -> mono
                ...
                .retryWhen(Retry.max(1).filter(OptimisticLockingFailureException.class::isInstance)) // if falling into retry case, it wont emit any event
