...
import com.vinsguru.cloudstreamkafkaplayground.practice.sec05.dto.PhysicalDelivery;
...
public class PhysicalDeliveryConsumer {
    @Bean
    public Function<Flux<Message<PhysicalDelivery>>, Mono<Void>> physicalDeliveryFunction() {
        return flux -> flux.map(MessageConverter::toRecord)
                .doOnNext(r -> {
                    log.info("physical delivery received: {}", r.message());
